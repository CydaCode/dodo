...
const WelcomeSection = () => {
  return (
    <div className="py-[30px]">
      ...
      <p className="text-[#344054] text-[14px] md:text-[16px] mt-[10px] md:mt-[18px]">
        Get ready to complete your research processes on Zadwax
      </p>
      <div className=" bg-[#F0EBFC] rounded-[12px] z-[1] mt-[40px] relative px-[20px] py-[40px]">
        <Image
          src={"/welcome-bg.png"}
          alt=""
          width={200}
        ...
        <div className="relative z-[10]">
          ...
          <h2 className="text-[#4A24A1] leading-[27px] md:leading-[34px] mt-[12px] text-[18px] md:text-[24px] max-w-[1035px] font-[500]">
